...
def pytorch2libtorch(model,
    ...
    # torch.jit.save(scripted_model, 'temp_scripted.pt')
    ...
    if verify:
        ...
        o1_v = model(imgs)
        # traced_model.train()
        o2_t = traced_model(imgs)
        traced_model.eval()
        o2_v = traced_model(imgs)
...
if __name__ == '__main__':
    ...
    # ------------------------------------temp test--------------------------------------
    shape = [512, 512]
    config = r"fcn_unet_s5-d16_ce-1.0-dice-3.0_64x64_40k_drive.py"
    checkpoint = r"fcn_unet_s5-d16_ce-1.0-dice-3.0_64x64_40k_drive_20211210_201820-785de5c2.pth"
    output_file = r"test_traintrace.pt"
